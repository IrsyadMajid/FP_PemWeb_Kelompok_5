...
$idPenjual = $data['pegawai_id'];

$penghasilanQuery = $conn->query("SELECT SUM(total_penjualan) AS total_bulan_lalu FROM penjualan WHERE MONTH(tanggal_penjualan) = MONTH(CURRENT_DATE - INTERVAL 1 MONTH) AND YEAR(tanggal_penjualan) = YEAR(CURRENT_DATE - INTERVAL 1 MONTH) AND pegawai_id = $idPenjual");
...
<body class="bg-white min-h-screen">
  ...
  <div class="lg:pl-[300px] pt-[80px] flex flex-col px-2 justify-center items-center min-h-screen lg:gap-12 gap-2">
    <div class="text-center">
      ...
      <p class="text-4xl font-semibold text-gray-800"><?php echo $data['nama']; ?></p>
